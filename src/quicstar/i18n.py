...
TRANSLATIONS: Dict[str, Translations] = {
    ...
    "ja": {
        ...
        "cli.protocol": "プロトコル選択（HTTP/3、HTTP/1.1のみ、または自動）",
        "cli.workers": "ワーカープロセス数",
        "cli.no_access_log": "アクセスログを無効化",
        "cli.log_level": "ログレベル",
        "cli.certfile": "TLS証明書（HTTP/3に必須）",
        "cli.keyfile": "TLS秘密鍵（HTTP/3に必須）",
        "cli.quic_bind": "任意のQUICバインド（例: '0.0.0.0:443'）",
        "error.protocol_mode": "protocol_mode は auto/http3/http1 のいずれかにしてください",
        "error.http3_cert": "HTTP/3 には TLS 証明書 (certfile) が必要です。",
        "error.key_without_cert": "keyfile を設定する場合、certfile も必要です。",
        "error.cert_without_key": "certfile を設定する場合、keyfile も必要です。",
    },
    "zh": {
